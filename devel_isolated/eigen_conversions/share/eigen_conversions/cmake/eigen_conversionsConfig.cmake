...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/dell/drl/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/dell/drl/devel_isolated/eigen_conversions)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/dell/drl/install_isolated)
...
if(NOT "/home/dell/drl/src/geometry/eigen_conversions/include;/usr/include/eigen3;/usr/local/include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/dell/drl/src/geometry/eigen_conversions/include;/usr/include/eigen3;/usr/local/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dell/drl/src/geometry/eigen_conversions/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dell/drl/devel_isolated/eigen_conversions/lib;/opt/ros/noetic/lib)
